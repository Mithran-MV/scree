...
// Phaser touches window at import time, so the console mounts on the client only.
const PhaserChamber = dynamic(
  () => import("@/components/PhaserChamber").then((m) => m.PhaserChamber),
  { ssr: false },
);
